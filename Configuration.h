...
#define STRING_CONFIG_H_AUTHOR "(Jonhys, SP5-V3)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Sapphire Plus 5 V3"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 320, 320, 1600, 582.3 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 1000, 1000, 35, 70 }
...
#define XY_PROBE_FEEDRATE (155*60)
